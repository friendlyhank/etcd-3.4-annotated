...
running(leaking) after all tests.
	...
	import "hank.com/etcd-3.3.12-annotated/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "hank.com/etcd-3.3.12-annotated/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "hank.com/etcd-3.3.12-annotated/pkg/logutil.(*MergeLogger).outputLoop") ||
