...
running(leaking) after all tests.
	...
	import "github.com/friendlyhank/etcd-3.4-annotated/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/friendlyhank/etcd-3.4-annotated/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/friendlyhank/etcd-3.4-annotated/pkg/logutil.(*MergeLogger).outputLoop") ||
